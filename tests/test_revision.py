...
def test_it_parses_ancestor_ref():
    assert_parse("@~3", Revision.Ancestor(Revision.Ref("HEAD"), 3))


def test_it_parses_chain_of_parents_and_ancestors():
    expr = "@~2^^~3"
