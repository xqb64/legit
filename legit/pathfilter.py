...
class Trie:
    ...
    def __init__(self, matched: bool = False, children: defaultdict[Path, 'Trie'] | None = None) -> None:
...
class PathFilter:
    ...
    def each_entry(self, entries: dict[Path, DatabaseEntry]) -> Generator[tuple[Path, DatabaseEntry]]:
